...
import { Card, Row, Col, Button, Table, Tag, Statistic } from "antd";
import {
  UserOutlined,
...
const Dashboard: React.FC = () => {
  ...
  const outOfStockColumns = [
    ...
    { title: "Tên sản phẩm", dataIndex: "name", key: "name" },
    {
      ...
      key: "image",
      render: (text: string) => (
        <img src={text} alt="Product" className="w-16 h-16 object-cover" />
      ),
    },
    { title: "Số lượng", dataIndex: "quantity", key: "quantity" },
    {
  ...
  const outOfStockData = [
    {
      ...
      image:
        "https://www.petmart.vn/wp-content/uploads/2019/05/tui-dung-cho-meo-anime-nhieu-mau-sac-khong-hoa-tiet.jpg",
      quantity: "0",
      status: "Hết hàng",
      price: "170.000 VNĐ",
      category: "Phụ kiện",
            ...
            >
              <Card bordered={false} className="shadow-sm">
                <Statistic
                  ...
                  value={5}
                  prefix={
                    <TagsOutlined className="text-cyan-500 text-xl mr-2" />
                  }
                  suffix="tài khoản"
                />
              </Card>
            ...
            >
              <Card bordered={false} className="shadow-sm">
                <Statistic
                  ...
                  value={457}
                  prefix={
                    <ShoppingCartOutlined className="text-yellow-500 text-xl mr-2" />
                  }
                  suffix="đơn hàng"
                />
              </Card>
            ...
            >
              <Card bordered={false} className="shadow-sm">
                <Statistic
                  ...
                  value={1}
                  prefix={
                    <ExceptionOutlined className="text-yellow-500 text-xl mr-2" />
                  }
                  suffix="sản phẩm"
                />
              </Card>
