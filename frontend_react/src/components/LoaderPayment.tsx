    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="relative">
        ...
        <div className="h-24 w-24">
          ...
          <div className="absolute h-24 w-24 animate-spin rounded-full border-4 border-t-4 border-transparent border-t-[#22A6DF]"></div>
        ...
        <div className="mt-4 text-center">
          <p className="text-lg font-medium text-[#22A6DF]">
            Đang xử lý yêu cầu của bạn. Vui long đợi chút nhé
          </p>
