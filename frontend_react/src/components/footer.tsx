  ...
  return (
    <>
      <footer className="border-y border-dashed border-gray-300 px-4 py-4 text-black sm:px-6 sm:py-5 lg:px-[154px]">
        <ul className="fixed bottom-52 right-3 flex flex-col gap-3 z-50">
          <li className="relative group">
            <a
              className="flex items-center justify-center w-11 h-11 rounded-full bg-gradient-to-b from-[#e8434c] to-[#d61114] hover:scale-110 transition-transform duration-200"
              href="tel:0393153129"
              rel="nofollow"
              aria-label="phone"
            >
              ...
              <span className="absolute right-14 top-1/2 -translate-y-1/2 bg-gray-800 text-white text-sm px-3 py-1 rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-300 whitespace-nowrap">
          ...
          <li className="relative group">
            <a
              className="flex items-center justify-center w-11 h-11 rounded-full bg-gradient-to-b from-[#3985f7] to-[#1272e8] hover:scale-110 transition-transform duration-200"
              href="//zalo.me/0393153129"
              target="_blank"
            ...
            >
              ...
              >
                ...
                <g clipPath="url(#clip0)">
                  ...
                  />
                  <path
                    d="M17.6768 21.6754C18.5419 21.6754 19.3555 21.6698 20.1633 21.6754C20.6159 21.6809 20.8623 21.8638 20.9081 22.213C20.9597 22.6509 20.6961 22.9447 20.2034 22.9502C19.2753 22.9613 18.3528 22.9558 17.4247 22.9558C17.1554 22.9558 16.8919 22.9669 16.6226 22.9502C16.2903 22.9336 15.9637 22.8671 15.8033 22.5345C15.6429 22.2019 15.7575 21.9026 15.9752 21.631C16.8575 20.5447 17.7455 19.4527 18.6336 18.3663C18.6851 18.2998 18.7367 18.2333 18.7883 18.1723C18.731 18.0781 18.6508 18.1224 18.582 18.1169C17.9633 18.1114 17.3388 18.1169 16.72 18.1114C16.5768 18.1114 16.4335 18.0947 16.296 18.067C15.9695 17.995 15.7689 17.679 15.8434 17.3686C15.895 17.158 16.0669 16.9862 16.2846 16.9363C16.4221 16.903 16.5653 16.8864 16.7085 16.8864C17.7284 16.8809 18.7539 16.8809 19.7737 16.8864C19.9571 16.8809 20.1347 16.903 20.3123 16.9474C20.7019 17.0749 20.868 17.4241 20.7133 17.7899C20.5758 18.1058 20.3581 18.3774 20.1404 18.649C19.3899 19.5747 18.6393 20.4948 17.8888 21.4093C17.8258 21.4814 17.7685 21.5534 17.676 ПОКЕТ4З"
                    fill="white"
                  />
                  <path
          ...
          <li className="relative group">
            <a
              className="flex items-center justify-center w-11 h-11 rounded-full bg-gradient-to-b from-[#f5ae16] to-[#d99009] hover:scale-110 transition-transform duration-200"
              href="/pages/lien-he"
              aria-label="Liên hệ"
            >
              <svg
              ...
              >
                ...
                <defs>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="50%" stopColor="#f5ae16" />
                    <stop offset="100%" stopColor="#d99009" />
                  </linearGradient>
                </defs>
              </svg>
              <span className="absolute right-14 top-1/2 -translate-y-1/2 bg-gray-800 text-white text-sm px-3 py-1 rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-300 whitespace-nowrap">
