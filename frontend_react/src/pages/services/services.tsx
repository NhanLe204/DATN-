...
const SpaBookingForm: React.FC = () => {
  ...
  const removePetForm = (indexToRemove: number) => {
    if (petForms.length > 1) {
      // Only allow removal if there's more than 1 form
                ...
                <div className="flex space-x-4 mb-4">
                  ...
                  >
                    <Select placeholder="Dịch vụ" className="w-full">
                      ...
                      <Option value="combo-bath-trim">
                        Combo tắm - cắt, tỉa lông
                      </Option>
                      <Option value="combo-bath-high">
                        Combo tắm - cao lông
                      </Option>
                    </Select>
                  </Form.Item>
