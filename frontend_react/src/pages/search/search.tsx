...
export default function Search() {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [priceRanges, selectedBrands, selectedTags, sort, selectedCategory, keyword]);
                    ...
                    >
                        ...
                        {keyword.trim() && (
                            <div className="mb-4">
                                <Text className="text-gray-700 text-3xl flex justify-center">
                                    Tìm thấy {sortedData.length} kết quả cho "<strong>{keyword}</strong>"
                                </Text>
                            </div>
                        )}
                        ...
                        {loading ? (
                            ...
                            <div className="flex h-60 flex-col items-center justify-center text-center">
                                ...
                                <p className="text-gray-500 text-xs">Vui lòng thử lại với từ khóa hoặc bộ lọc khác</p>
                            </div>
                        )}
                    </Col>
                </div>
