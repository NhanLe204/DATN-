...
export default function UserProfile() {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      //     `${ENV_VARS.VITE_API_URL}/api/v1/users/${accountID}`,
      //     {
      //       method: "PATCH",
      //       headers: {
    ...
    <>
      ...
      <div className="flex m-4 flex-col gap-6 md:flex-row md:gap-8">
          ...
          >
            ...
            {isEditing && (
              <Item>
                <Button
                  htmlType="submit"
                  className="w-1/4 bg-[#22A6DF] hover:bg-[#1890ff] rounded text-white mr-2"
                >
                  Lưu
                </Button>
                <Button
                  className="w-1/4 bg-gray-300 hover:bg-gray-400 rounded text-gray-700"
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
          <Avatar
            size={120}
            src={user?.avatar || "/images/avatar/avatar1.png"}
          />
          <Upload>
            <Button
              icon={<UploadOutlined />}
          ...
          <p className="text-xs text-gray-500 text-center">
            Dung lượng file tối đa: 1MB <br /> Định dạng: JPG, PNG
          </p>
        </div>
      </div>
    </>
        ...
        <div className="w-full md:w-1/2">
          ...
          >
            ...
            <Item
              name="newPassword"
              label={
                <span className="text-base font-semibold">Mật khẩu mới</span>
              }
              rules={[
  ...
  return (
    <div className="flex my-6 flex-col gap-6 md:flex-row md:gap-8 sm:px-[40px] lg:px-[154px]">
      <Card
        className="w-full md:w-1/4 border-none"
      ...
      >
        ...
        <div className="space-y-2 text-lg text-gray-600">
          ...
          <div
            ...
            onClick={() =>
              (window.location.href = "/userprofile/change-password")
            }
          >
            Đổi mật khẩu
          </div>
