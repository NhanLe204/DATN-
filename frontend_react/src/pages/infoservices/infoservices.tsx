      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Text className="mb-7 text-gray-800">
          <strong className="mb-2 text-xl">
            I. NHỮNG CAM KẾT TẠI PET HEAVEN VỚI KHÁCH HÀNG:
          </strong>
          <br />
          <strong className="ml-2 text-lg">
            1. Đội ngũ nhân viên tại Pet Heaven làm việc nhiệt huyết và trách
            nhiệm với công việc:
          </strong>
          <Paragraph className="ml-2 text-base text-gray-700">
            ...
            lòng chia sẻ kinh nghiệm chăm sóc khi thú cưng của bạn gặp các vấn
            đề về sức khỏe. Các dịch vụ và sản phẩm phân phối tại Pet Heaven
          ...
          <Paragraph className="ml-2 text-base text-gray-700">
            ...
            và cạnh tranh nhất hiện nay để tất cả thú cưng đều có thể đến và
            trải nghiệm dịch vụ.
            <br />
            - Bên cạnh chi phí hợp lý, còn có rất nhiều ưu đãi kèm theo ví dụ
            như: giảm giá 30% cho các dịch vụ ...
            <br />- Pet Heaven không ngừng phát triển trình độ và tay nghề của
            nhân viên spa để đem lại kết quả tốt nhất khi làm dịch vụ. Tại Pet
            Heaven, chúng tôi không cam kết mức giá dịch vụ rẻ nhất nhưng với
            mức giá đó, đảm bảo Khách hàng sẽ hài lòng nhất khi chọn dịch vụ tại
            Pet Heaven.
          </Paragraph>
          <strong className="mb-2 text-xl">
        ...
        <div className="mb-7 grid gap-8 md:grid-cols-2">
          <Card title="BẢNG GIÁ TẮM CHO CHÓ" bordered={false}>
            <Table
              columns={dogBathColumns}
              dataSource={dogBathData}
              pagination={false}
            />
          </Card>
          <Card title="BẢNG GIÁ TẮM CHO MÈO" bordered={false}>
            <Table
              columns={catBathColumns}
              dataSource={catBathData}
              pagination={false}
            />
          </Card>
        ...
        <Text className="mb-7 text-gray-800">
          ...
          <br />
          <Paragraph className="ml-2 text-base text-gray-700">
            - Pet Heaven không nhận spa khi các bé đang mang thai, đang điều trị
            bệnh, mới phẫu thuật, có tiểu sử bệnh hen, co giật hay các bệnh lý
            khác khiến thú cưng không có khả năng tự chủ.
            <br />
            - Để đảm bảo sức khỏe cho thú cưng đến làm dịch vụ spa, khi đưa các
            bé đến Khách hàng lưu ý: Không để thú cưng quá đói, quá no hay vận
            động quá sức trước khi đến spa. Nếu thú cưng có những biểu hiện bất
            thường xin hãy liên hệ với Pet Heaven để được hỗ trợ.
            <br />- Làm xong dịch vụ, Khách hàng vui lòng kiểm tra thật kỹ thú
            cưng của mình khi đến đón về. Điều này nhằm đảm bảo nhân viên spa
            tại Pet Heaven đã hoàn thành đúng quy trình spa cho các bé. Nếu có
            bất cứ điều gì chưa hài lòng, hãy liên hệ với Pet Heaven qua
