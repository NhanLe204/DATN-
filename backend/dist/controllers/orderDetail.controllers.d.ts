...
export declare const createOrderDetail: (req: Request, res: Response) => Promise<any>;
export declare const updateOrderDetail: (req: Request, res: Response) => Promise<any>;
export declare const deleteOrderDetail: (req: Request, res: Response) => Promise<any>;
export declare const getBookingsByUserId: (req: Request<{}, {}, {}, {
    userId?: string;
